...
void UDPSender::send()
{
    ...
    ss << "CALLSIGN=XPL001,LAT=" << XPLMGetDatad(drefLatitude)
       ...
       << ",COM1_VOL=" << XPLMGetDataf(drefCom1Volume) << ",COM1_PWR=100.0,COM1_SQC=0.1,COM1_CWKHZ=8.33"
       ...
       << ",COM2_VOL=" << XPLMGetDataf(drefCom2Volume) << ",COM2_PWR=100.0,COM2_SQC=0.1,COM2_CWKHZ=8.33"
